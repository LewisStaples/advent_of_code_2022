...
while True:
    ...
    for direction in [
        ...
        if acceptable(distance_map, height_map, position_now, potential_new_position):
            ...
            # if problem solved
            if height_map[potential_new_position[0]][potential_new_position[1]] in [
                "S",
                "a",
            ]:
                print(
                    f"Fewest steps from E to any elevation a (part B) is: {distance_map[potential_new_position[0]][potential_new_position[1]]}\n"
                )
